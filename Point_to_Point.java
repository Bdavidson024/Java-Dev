 ...
 * Date: 09/30/2022
 * Purpose: Programming Excercise #21
 */
...
public class Point_to_Point extends Application {
	...
	public void start(Stage primaryStage) {
		...
		Text text = new Text((x1 + x2)/2,(y1+y2)/2,getDistance(x1,y1,x2,y2)+"");
		
		pane.getChildren().addAll(circle1,circle2,line,text);
		
		Scene scene = new Scene(pane,paneWidth,paneHeight);
		primaryStage.setTitle("Chapter14Lab3");
